...
internal class AudioQtStateListener @Inject constructor(
    private val scope : CoroutineScope,
    private val autioQtStateManager : AudioQtStateManager
) : Player.Listener {
    ...
    private fun updatePlayState() {
        ...
        autioQtStateManager.audioQtState = AudioQtState(
            isPlaying = when {
